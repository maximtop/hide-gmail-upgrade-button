...
| Icon | `assets/icon/` master + `src/assets/icons/` PNGs (`pnpm icons`) | 128 px for the listing |
| Screenshots | `assets/store/screenshots/{en,ru}/screenshot-{1..4}.png`, generated by `pnpm store:assets` (mock data only, captions localizable in the generator) | 1280×800, up to 5 |
| Promo tiles | `assets/store/small-promo-tile.png` (440×280), `assets/store/marquee-promo-tile.png` (1400×560, optional), same generator | exact sizes |
